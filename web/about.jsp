...
<script>
    ...
    var dataCount = ${bookListCount};  //数据总数
    ...
    function showBookList(){
        ...
        $.post("${pageContext.request.contextPath}/userOperationServlet", {
                M:"aboutBook",
                categoryId:${category.bookCategoryId},
                before : 0,
                dataItemCont : 20
            },function (data) {
                $("#showBook").html(data);
...
<div class="fh5co-narrow-content">
    <div class="row row-bottom-padded-md">
        <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
            <img class="img-responsive" src="${category.bookImgPath}" alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
        </div>
        <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
            <h2 class="fh5co-heading">分类介绍</h2>
            <p>${category.bookDis_1}</p>
            <p>${category.bookDis_2}</p>
        </div>
    </div>
</div>
...
<div class="fh5co-more-contact">
    <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft" >该类图书</h2>
    <div class="row">
    ...
    <div class="animate-box">
        ...
        <span>
                    ...
                    页,共<span id="dataCount">${bookList.size()}</span>条记录
            </span>
        <div>
                <span class="fenye">
